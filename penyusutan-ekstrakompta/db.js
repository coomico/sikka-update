// Constants
const DB_NAME = 'LaporanPenyusutanDB';
const DB_VERSION = 1;

// Store names
const STORES = {
  LAPORAN: 'laporan_penyusutan_ekstrakompta',
  BARANG: 'barang_penyusutan_ekstrakompta'
};
...
function openDB() {
  return new Promise((resolve, reject) => {
    ...
    request.onupgradeneeded = (event) => {
      ...
      // Create laporan_penyusutan_ekstrakompta store
      ...
      // Create barang_penyusutan_ekstrakompta store
      if (!db.objectStoreNames.contains(STORES.BARANG)) {
        const barangStore = db.createObjectStore(STORES.BARANG, { 
          keyPath: ['kode', 'laporan_created_at'] // Composite key for uniqueness
        });
